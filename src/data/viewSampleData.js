 ...
 * **views-2:** Service agreements merged under `contracts`; quotes + invoices under `proposals`.
...
const VIEW_SAMPLE_DATA = {
  contracts: {
    ...
    documents: [
      ...
      baseDoc({ id: 'sa1', name: 'Service Level Agreement - DataCenter Solutions', documentType: 'Service Agreement', participants: 'Emily Gold, Nathan Howard', status: 'Completed', amount: '$45,000.00', created: 'Sep 8, 2024', folder: 'sa-support' }),
      baseDoc({ id: 'sa2', name: 'Support Contract - FitLife Wellness', documentType: 'Service Agreement', participants: 'Andreya Triana', status: 'Sent', amount: '$12,000.00', created: 'Nov 12, 2024', folder: 'sa-support' }),
      baseDoc({ id: 'sa2b', name: '24/7 Support SLA - Priority tier', documentType: 'Service Agreement', participants: 'Nathan Howard', status: 'Awaiting approval', amount: '$28,000.00', created: 'Jan 4, 2025', folder: 'sa-support' }),
      baseDoc({ id: 'sa2c', name: 'Support renewal - FY2025', documentType: 'Service Agreement', participants: 'Will Holland', status: 'Draft', amount: '$19,500.00', created: 'Dec 1, 2024', folder: 'sa-support' }),
      baseDoc({ id: 'sa3', name: 'Maintenance Agreement - StyleHub Fashion', documentType: 'Service Agreement', participants: 'Mariel Stacey', status: 'Draft', amount: '$8,500.00', created: 'Sep 18, 2024', folder: 'sa-maintenance' }),
      baseDoc({ id: 'sa4', name: 'Annual Support Agreement - VentureCapital Pro', documentType: 'Service Agreement', participants: 'Will Holland', status: 'Completed', amount: '$22,000.00', created: 'Jul 25, 2024', folder: 'sa-maintenance' }),
      baseDoc({ id: 'sa4b', name: 'Preventive maintenance - Hardware fleet', documentType: 'Service Agreement', participants: 'Ops', status: 'Sent', amount: '$34,000.00', created: 'Oct 3, 2024', folder: 'sa-maintenance' }),
      baseDoc({ id: 'sa4c', name: 'Maintenance addendum - Uptime guarantee', documentType: 'Service Agreement', participants: 'Legal', status: 'Completed', amount: '$0.00', created: 'Aug 19, 2024', folder: 'sa-maintenance' }),
      baseDoc({ id: 'sa5', name: 'Professional Services Agreement - MedTech Innovations', documentType: 'Professional Services Agreement', participants: 'CTO', status: 'Awaiting approval', amount: '$120,000.00', created: 'Oct 30, 2024', folder: 'sa-enterprise' }),
      baseDoc({ id: 'sa5b', name: 'Implementation services - ERP rollout', documentType: 'Professional Services Agreement', participants: 'PMO', status: 'Sent', amount: '$275,000.00', created: 'Nov 27, 2024', folder: 'sa-enterprise' }),
      baseDoc({ id: 'sa5c', name: 'Managed services - Security operations', documentType: 'Professional Services Agreement', participants: 'Security', status: 'Draft', amount: '$410,000.00', created: 'Jan 11, 2025', folder: 'sa-enterprise' }),
      baseDoc({ id: 'sa6', name: 'Service Agreement - API gateway program', documentType: 'Service Agreement', participants: 'Engineering', status: 'Completed', amount: '$88,000.00', created: 'Nov 5, 2024' }),
      baseDoc({ id: 'sa7', name: 'Service Agreement - Data residency pack', documentType: 'Service Agreement', participants: 'Sarah Johnson', status: 'Sent', amount: '$54,000.00', created: 'Dec 16, 2024' }),
      baseDoc({ id: 'sa8', name: 'Service Agreement - Training & enablement', documentType: 'Service Agreement', participants: 'Customer Success', status: 'Draft', amount: '$36,000.00', created: 'Feb 2, 2025' }),
    ],
  },
  ...
  proposals: {
    folders: [
      ...
      { id: 'invoices-unpaid', name: 'Unpaid invoices', itemCount: 4, avatar: profileAvatar, created: 'Jan 10, 2025', documents: [] },
      { id: 'invoices-paid', name: 'Paid invoices', itemCount: 4, avatar: profileAvatar, created: 'Nov 2, 2024', documents: [] },
