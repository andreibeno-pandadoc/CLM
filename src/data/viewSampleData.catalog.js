...
export const VIEW_SAMPLE_DATA_MAIN = {
  contracts: {
    ...
    documents: [
      baseDoc({ id: 'c-root-1', name: 'Contract pack — Board summary FY25', documentType: 'Other', participants: 'Legal', status: 'Draft', amount: '', created: 'Mar 12, 2025' }),
      baseDoc({ id: 'c-root-2', name: 'Amendment — Payment terms (root)', documentType: 'Amendment Agreement', participants: 'Finance', status: 'Sent', amount: '$0.00', created: 'Mar 8, 2025' }),
      baseDoc({ id: 'c-root-3', name: 'Side letter — Liability cap', documentType: 'Other', participants: 'Legal', status: 'Awaiting approval', amount: '', created: 'Mar 5, 2025' }),
      baseDoc({ id: 'c-root-4', name: 'Contract review — Redlines v3', documentType: 'Other', participants: 'Procurement', status: 'Draft', amount: '', created: 'Mar 1, 2025' }),
      baseDoc({ id: 'c-root-5', name: 'Executed PDF — Counterparty signed', documentType: 'Other', participants: 'Legal', status: 'Completed', amount: '', created: 'Feb 26, 2025' }),
      ...
      baseDoc({ id: 'c6', name: 'Partnership Agreement - Reseller network', documentType: 'Partnership Agreement', participants: 'Partnerships', status: 'Completed', amount: '$0.00', created: 'Jul 14, 2024' }),
      baseDoc({ id: 'c6b', name: 'Franchise Agreement - EMEA region', documentType: 'Franchise Agreement', participants: 'Legal', status: 'Draft', amount: '$0.00', created: 'Feb 10, 2025' }),
      baseDoc({ id: 'c6c', name: 'Affiliate Agreement - Referral program', documentType: 'Affiliate Agreement', participants: 'Marketing', status: 'Sent', amount: '$0.00', created: 'Nov 30, 2024' }),
      ...
      baseDoc({ id: 'c11', name: 'Vendor supply agreement - Declined', documentType: 'Purchase Agreement', participants: 'Procurement', status: 'Rejected', amount: '$340,000.00', created: 'Jan 28, 2025' }),
    ],
  },
  ...
  'service-agreements': {
    ...
    documents: [
      ...
      baseDoc({ id: 'sa5', name: 'Professional Services Agreement - MedTech Innovations', documentType: 'Professional Services Agreement', participants: 'CTO', status: 'Awaiting approval', amount: '$120,000.00', created: 'Oct 30, 2024' }),
      baseDoc({ id: 'sa5b', name: 'Implementation services - ERP rollout', documentType: 'Service Agreement', participants: 'PMO', status: 'Sent', amount: '$275,000.00', created: 'Nov 27, 2024' }),
      baseDoc({ id: 'sa5c', name: 'Managed services - Security operations', documentType: 'Service Agreement', participants: 'Security', status: 'Draft', amount: '$410,000.00', created: 'Jan 11, 2025' }),
      ...
      baseDoc({ id: 'sa-root-1', name: 'Service overview — Customer success deck', participants: 'CS Leadership', status: 'Sent', amount: '', created: 'Mar 10, 2025' }),
      baseDoc({ id: 'sa-root-2', name: 'Uplift request — Support hours', participants: 'Ops', status: 'Draft', amount: '$24,000.00', created: 'Mar 6, 2025' }),
  ...
  proposals: {
    ...
    documents: [
      ...
      baseDoc({ id: 'p6', name: 'Mobile App Development - FitLife Wellness', documentType: 'Service Proposal', participants: 'Product', status: 'Completed', amount: '$95,000.00', created: 'Nov 12, 2024' }),
      baseDoc({ id: 'p6b', name: 'Investment Proposal - Analytics platform', documentType: 'Investment Proposal', participants: 'Finance', status: 'Draft', amount: '$1,500,000.00', created: 'Aug 22, 2024' }),
      baseDoc({ id: 'p6c', name: 'Loan Proposal - Working capital facility', documentType: 'Loan Proposal', participants: 'CFO', status: 'Sent', amount: '$5,000,000.00', created: 'Nov 1, 2024' }),
      ...
      baseDoc({ id: 'p-root-1', name: 'Proposal — Exec steering notes', documentType: 'Proposal', participants: 'CEO', status: 'Draft', amount: '', created: 'Mar 14, 2025' }),
      baseDoc({ id: 'p-root-2', name: 'Win plan — Enterprise account', documentType: 'Business Plan', participants: 'Sales', status: 'Sent', amount: '', created: 'Mar 9, 2025' }),
      ...
      baseDoc({ id: 'p11', name: 'Termination Agreement - Program wind-down', documentType: 'Termination Agreement', participants: 'Legal', status: 'Awaiting approval', amount: '$0.00', created: 'Feb 8, 2025' }),
    ],
  },
  ...
  quotes: {
    ...
    documents: [
      ...
      baseDoc({ id: 'q6', name: 'Quote - Legacy pricing FY23', documentType: 'Quote', participants: 'Mike Chen', status: 'Completed', amount: '$42,000.00', created: 'Mar 3, 2024' }),
      baseDoc({ id: 'q7', name: 'Quote - Superseded by Q4 bundle', documentType: 'Quote', participants: 'Alex Martinez', status: 'Completed', amount: '$198,000.00', created: 'Apr 18, 2024' }),
      baseDoc({ id: 'q8', name: 'Order Form - Old SKU list', documentType: 'Order Form', participants: 'Sales', status: 'Completed', amount: '$12,000.00', created: 'May 21, 2024' }),
      ...
      baseDoc({ id: 'q-root-1', name: 'Quote — Spot buy approval', documentType: 'Quote', participants: 'Procurement', status: 'Draft', amount: '$8,400.00', created: 'Mar 11, 2025' }),
      baseDoc({ id: 'q-root-2', name: 'Quote — Renewal placeholder', documentType: 'Quote', participants: 'Sales', status: 'Sent', amount: '$0.00', created: 'Mar 7, 2025' }),
      baseDoc({ id: 'q-root-3', name: 'Quote — Sandbox environment', documentType: 'Quote', participants: 'Engineering', status: 'Completed', amount: '$3,200.00', created: 'Mar 3, 2025' }),
  ...
  ndas: {
    ...
    documents: [
      ...
      baseDoc({ id: 'n6', name: 'Mutual NDA - Joint venture exploration', participants: 'Legal', status: 'Completed', amount: '', created: 'Aug 30, 2024' }),
      baseDoc({ id: 'n7', name: 'Tripartite NDA - Data sharing', participants: 'Sarah Johnson', status: 'Sent', amount: '', created: 'Nov 5, 2024' }),
      baseDoc({ id: 'n8', name: 'Mutual NDA - Partner ecosystem', participants: 'Partnerships', status: 'Draft', amount: '', created: 'Dec 20, 2024' }),
      ...
      baseDoc({ id: 'n-root-1', name: 'NDA — Fast-track template', participants: 'Legal', status: 'Draft', amount: '', created: 'Mar 13, 2025' }),
      baseDoc({ id: 'n-root-2', name: 'Confidentiality memo — Exec session', participants: 'Legal', status: 'Sent', amount: '', created: 'Mar 4, 2025' }),
  ...
  invoices: {
    ...
    documents: [
      ...
      baseDoc({ id: 'inv6', name: 'Invoice #INV-2024-1101 - Disputed line items', documentType: 'Invoice', participants: 'Mike Chen', status: 'Sent', amount: '$33,000.00', created: 'Jan 9, 2025', paymentStatus: 'Unpaid' }),
      baseDoc({ id: 'inv7', name: 'Invoice #INV-2024-1102 - AR hold', documentType: 'Invoice', participants: 'Sarah Johnson', status: 'Awaiting approval', amount: '$12,000.00', created: 'Jan 11, 2025', paymentStatus: 'Unpaid' }),
      baseDoc({ id: 'inv8', name: 'Invoice #INV-2024-1103 - Credit memo pending', documentType: 'Invoice', participants: 'Finance', status: 'Draft', amount: '$8,500.00', created: 'Jan 14, 2025', paymentStatus: 'Unpaid' }),
      ...
      baseDoc({ id: 'inv-root-1', name: 'Invoice — Pro forma FY26', documentType: 'Invoice', participants: 'FP&A', status: 'Draft', amount: '$0.00', created: 'Mar 15, 2025' }),
      baseDoc({ id: 'inv-root-2', name: 'Credit note — Pending approval', documentType: 'Invoice', participants: 'AR', status: 'Awaiting approval', amount: '-$4,500.00', created: 'Mar 10, 2025' }),
      baseDoc({ id: 'inv-root-3', name: 'Invoice — Intercompany charge', documentType: 'Invoice', participants: 'Finance', status: 'Sent', amount: '$22,000.00', created: 'Mar 6, 2025' }),
    ],
  },
  ...
  forms: {
    ...
    documents: [
      ...
      baseDoc({ id: 'f6', name: 'Job Application Form - Engineering', documentType: 'Job Application Form', participants: 'Recruiting', status: 'Sent', amount: '', created: 'Jan 7, 2025' }),
      baseDoc({ id: 'f7', name: 'Performance Review Form - H1 cycle', documentType: 'Performance Review Form', participants: 'People Ops', status: 'Completed', amount: '', created: 'Jan 3, 2025' }),
      baseDoc({ id: 'f8', name: 'Student Application Form - Intern cohort', documentType: 'Student Application Form', participants: 'HR', status: 'Draft', amount: '', created: 'Feb 1, 2025' }),
      ...
      baseDoc({ id: 'f-root-1', name: 'Form — Intake stub (root)', documentType: 'Form', participants: 'Ops', status: 'Draft', amount: '', created: 'Mar 12, 2025' }),
      baseDoc({ id: 'f-root-2', name: 'Survey — NPS follow-up', documentType: 'Form', participants: 'CX', status: 'Sent', amount: '', created: 'Mar 8, 2025' }),
    ],
  },
  ...
  collaterals: {
    ...
    documents: [
      ...
      baseDoc({ id: 'col6', name: 'Certification badge pack - Partner tier', documentType: 'Certificate & Credential', participants: 'Brand', status: 'Sent', amount: '', created: 'Jan 9, 2025' }),
      baseDoc({ id: 'col7', name: 'Promo flyer - Webinar series', documentType: 'Informational & Promotional Material', participants: 'Marketing', status: 'Draft', amount: '', created: 'Jan 16, 2025' }),
      baseDoc({ id: 'col8', name: 'Brand guidelines - Typography 2025', documentType: 'Informational & Promotional Material', participants: 'Brand', status: 'Completed', amount: '', created: 'Dec 22, 2024' }),
      ...
      baseDoc({ id: 'col10', name: 'Tradeshow flyer - Draft review', documentType: 'Informational & Promotional Material', participants: 'Events', status: 'Awaiting approval', amount: '', created: 'Feb 10, 2025' }),
      baseDoc({ id: 'col-root-1', name: 'Collateral — Pricing tear sheet', documentType: 'Informational & Promotional Material', participants: 'Product Marketing', status: 'Draft', amount: '', created: 'Mar 14, 2025' }),
      baseDoc({ id: 'col-root-2', name: 'Battlecard — vs competitor A', documentType: 'Informational & Promotional Material', participants: 'Sales', status: 'Completed', amount: '', created: 'Mar 9, 2025' }),
      baseDoc({ id: 'col-root-3', name: 'Analyst brief — Q1 update', documentType: 'Informational & Promotional Material', participants: 'IR', status: 'Sent', amount: '', created: 'Mar 5, 2025' }),
    ],
  },
};
...
export const VIEW_SAMPLE_DATA_TEAM = {
  sales: {
    ...
    documents: [
      ...
      baseDoc({ id: 's5', name: 'Partnership Proposal — Co-sell', documentType: 'Partnership Proposal', participants: 'Alliances', status: 'Sent', amount: '$0.00', created: 'Oct 15, 2024' }),
      baseDoc({ id: 's5b', name: 'License Agreement — OEM embed', documentType: 'License Agreement', participants: 'Legal', status: 'Awaiting approval', amount: '$500,000.00', created: 'Jan 5, 2025' }),
      baseDoc({ id: 's5c', name: 'Sales Commission Agreement — FY plan', documentType: 'Sales Commission Agreement', participants: 'Finance', status: 'Completed', amount: '$0.00', created: 'Dec 1, 2024' }),
      baseDoc({ id: 's5d', name: 'Channel partner — Agreement expired', documentType: 'Partnership Proposal', participants: 'Alliances', status: 'Expired', amount: '$0.00', created: 'Mar 1, 2024' }),
      ...
      baseDoc({ id: 's-root-1', name: 'Deal desk — Exception log', documentType: 'Business Letter', participants: 'RevOps', status: 'Draft', amount: '', created: 'Mar 15, 2025' }),
      baseDoc({ id: 's-root-2', name: 'Territory plan — H1 snapshot', documentType: 'Business Plan', participants: 'Sales', status: 'Sent', amount: '', created: 'Mar 11, 2025' }),
      baseDoc({ id: 's-root-3', name: 'Pipeline export — Weekly', documentType: 'Report', participants: 'Sales', status: 'Completed', amount: '', created: 'Mar 8, 2025' }),
    ],
  },
  ...
  hr: {
    ...
    documents: [
      ...
      baseDoc({ id: 'h5', name: 'Medical Form — Benefits enrollment', documentType: 'Medical Form', participants: 'Payroll', status: 'Completed', amount: '', created: 'Jan 2, 2025' }),
      baseDoc({ id: 'h5b', name: 'Certificate & Credential — Training complete', documentType: 'Certificate & Credential', participants: 'L&D', status: 'Completed', amount: '', created: 'Dec 18, 2024' }),
      baseDoc({ id: 'h5c', name: 'Social Security Benefits Application Form', documentType: 'Social Security Benefits Application Form', participants: 'Payroll', status: 'Draft', amount: '', created: 'Jan 20, 2025' }),
      baseDoc({ id: 'h5d', name: 'Performance Review Form — Not signed', documentType: 'Performance Review Form', participants: 'Manager', status: 'Not Signed', amount: '', created: 'Jan 25, 2025' }),
      ...
      baseDoc({ id: 'h-root-1', name: 'People ops — Headcount request', documentType: 'Form', participants: 'People Ops', status: 'Draft', amount: '', created: 'Mar 14, 2025' }),
      baseDoc({ id: 'h-root-2', name: 'Comp benchmark — Draft', documentType: 'Report', participants: 'HR', status: 'Sent', amount: '', created: 'Mar 10, 2025' }),
      baseDoc({ id: 'h-root-3', name: 'Policy FAQ — All-hands', documentType: 'Employee Policy', participants: 'Legal', status: 'Completed', amount: '', created: 'Mar 6, 2025' }),
    ],
  },
  ...
  legal: {
    ...
    documents: [
      ...
      baseDoc({ id: 'l5', name: 'Terms of Service Agreement — Product', documentType: 'Terms of Service Agreement', participants: 'Product Legal', status: 'Draft', amount: '', created: 'Sep 30, 2024' }),
      baseDoc({ id: 'l5b', name: 'Company Policy — Data retention', documentType: 'Company Policy', participants: 'Compliance', status: 'Sent', amount: '', created: 'Jan 7, 2025' }),
      baseDoc({ id: 'l5c', name: 'Consent Agreement — Marketing comms', documentType: 'Consent Agreement', participants: 'Privacy', status: 'Completed', amount: '', created: 'Nov 14, 2024' }),
      baseDoc({ id: 'l5d', name: 'Policy — Rejected by counsel', documentType: 'Company Policy', participants: 'Legal', status: 'Rejected', amount: '', created: 'Feb 7, 2025' }),
      ...
      baseDoc({ id: 'l-root-1', name: 'Legal memo — IP review', documentType: 'Business Letter', participants: 'Legal', status: 'Draft', amount: '', created: 'Mar 15, 2025' }),
      baseDoc({ id: 'l-root-2', name: 'Outside counsel — Matter 8842', documentType: 'Other', participants: 'Legal', status: 'Sent', amount: '', created: 'Mar 12, 2025' }),
      baseDoc({ id: 'l-root-3', name: 'Contract matrix — Renewal batch', documentType: 'Report', participants: 'Legal', status: 'Completed', amount: '', created: 'Mar 9, 2025' }),
      baseDoc({ id: 'l-root-4', name: 'Regulatory watch — Summary', documentType: 'Report', participants: 'Compliance', status: 'Viewed', amount: '', created: 'Mar 4, 2025' }),
    ],
  },
  ...
  finance: {
    ...
    documents: [
      ...
      baseDoc({ id: 'fi4', name: 'Investment Agreement — Series notes', documentType: 'Investment Agreement', participants: 'CFO', status: 'Sent', amount: '$2,000,000.00', created: 'Nov 1, 2024' }),
      baseDoc({ id: 'fi4b', name: 'Loan Agreement — Revolver extension', documentType: 'Loan Agreement', participants: 'Treasury', status: 'Awaiting approval', amount: '$10,000,000.00', created: 'Jan 3, 2025' }),
      baseDoc({ id: 'fi4c', name: 'Credit Agreement — Facility update', documentType: 'Credit Agreement', participants: 'Legal', status: 'Draft', amount: '$0.00', created: 'Feb 2, 2025' }),
      baseDoc({ id: 'fi4d', name: 'Credit line — Not signed', documentType: 'Credit Agreement', participants: 'Treasury', status: 'Not Signed', amount: '$0.00', created: 'Feb 9, 2025' }),
      ...
      baseDoc({ id: 'fi-root-1', name: 'Close checklist — Month end', documentType: 'Form', participants: 'Controller', status: 'Draft', amount: '', created: 'Mar 15, 2025' }),
      baseDoc({ id: 'fi-root-2', name: 'FX policy — Update draft', documentType: 'Company Policy', participants: 'Treasury', status: 'Sent', amount: '', created: 'Mar 11, 2025' }),
      baseDoc({ id: 'fi-root-3', name: 'Budget vs actual — Flash', documentType: 'Report', participants: 'FP&A', status: 'Completed', amount: '', created: 'Mar 7, 2025' }),
      baseDoc({ id: 'fi-root-4', name: 'Audit PBC — Outstanding items', documentType: 'Form', participants: 'Finance', status: 'Awaiting approval', amount: '', created: 'Mar 3, 2025' }),
    ],
  },
  ...
  marketing: {
    ...
    documents: [
      ...
      baseDoc({ id: 'm5', name: 'Affiliate Agreement — Partner network', documentType: 'Affiliate Agreement', participants: 'Partnerships', status: 'Awaiting approval', amount: '', created: 'Oct 8, 2024' }),
      baseDoc({ id: 'm5b', name: 'Informational & Promotional Material — One-sheet', documentType: 'Informational & Promotional Material', participants: 'Brand', status: 'Sent', amount: '', created: 'Dec 22, 2024' }),
      baseDoc({ id: 'm5c', name: 'Project Plan — Rebrand wave 2', documentType: 'Project Plan', participants: 'Creative', status: 'Draft', amount: '', created: 'Feb 1, 2025' }),
      baseDoc({ id: 'm5d', name: 'Promo pack — Expired campaign', documentType: 'Informational & Promotional Material', participants: 'Brand', status: 'Expired', amount: '', created: 'Jun 1, 2024' }),
      ...
      baseDoc({ id: 'm-root-1', name: 'Campaign calendar — Q2 draft', documentType: 'Project Plan', participants: 'Demand Gen', status: 'Draft', amount: '', created: 'Mar 14, 2025' }),
      baseDoc({ id: 'm-root-2', name: 'Brand voice — Style guide v2', documentType: 'Informational & Promotional Material', participants: 'Brand', status: 'Sent', amount: '', created: 'Mar 10, 2025' }),
      baseDoc({ id: 'm-root-3', name: 'Web refresh — Copy deck', documentType: 'Marketing Proposal', participants: 'Web', status: 'Completed', amount: '', created: 'Mar 6, 2025' }),
      baseDoc({ id: 'm-root-4', name: 'Analyst briefing — Slides', documentType: 'Informational & Promotional Material', participants: 'Comms', status: 'Viewed', amount: '', created: 'Mar 2, 2025' }),
    ],
  },
  ...
  procurement: {
    ...
    documents: [
      ...
      baseDoc({ id: 'pr6', name: 'Franchise Agreement — Regional operator', documentType: 'Franchise Agreement', participants: 'Legal', status: 'Awaiting approval', amount: '$0.00', created: 'Nov 12, 2024' }),
      baseDoc({ id: 'pr6b', name: 'Business Registration Form — New entity', documentType: 'Business Registration Form', participants: 'Tax', status: 'Draft', amount: '', created: 'Feb 2, 2025' }),
      baseDoc({ id: 'pr6c', name: 'Form — Vendor code of conduct ack', documentType: 'Form', participants: 'Procurement', status: 'Completed', amount: '', created: 'Jan 4, 2025' }),
      baseDoc({ id: 'pr6d', name: 'Partnership — Agreement expired', documentType: 'Partnership Agreement', participants: 'Legal', status: 'Expired', amount: '', created: 'Apr 1, 2023' }),
      ...
      baseDoc({ id: 'pr-root-1', name: 'Vendor scorecard — Q1', documentType: 'Report', participants: 'Procurement', status: 'Draft', amount: '', created: 'Mar 15, 2025' }),
      baseDoc({ id: 'pr-root-2', name: 'RFI — Cloud backup', documentType: 'Form', participants: 'IT', status: 'Sent', amount: '', created: 'Mar 12, 2025' }),
      baseDoc({ id: 'pr-root-3', name: 'Sourcing plan — Laptops', documentType: 'Business Plan', participants: 'Procurement', status: 'Completed', amount: '', created: 'Mar 8, 2025' }),
      baseDoc({ id: 'pr-root-4', name: 'Contract routing — Playbook', documentType: 'Form', participants: 'Legal', status: 'Awaiting approval', amount: '', created: 'Mar 4, 2025' }),
    ],
  },
};
