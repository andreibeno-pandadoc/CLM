...
export const VIEW_SAMPLE_DATA_MAIN = {
  contracts: {
    folders: [
      ...
      { id: 'contracts-additional', name: 'Additional sample contracts', itemCount: 3, avatar: profileAvatar, created: 'Mar 1, 2025', documents: [] },
    ],
    documents: [
      ...
      baseDoc({ id: 'c7', name: 'Purchase Agreement - RetailMax 2024', documentType: 'Purchase Agreement', participants: 'Will Holland', status: 'Completed', amount: '$180,000.00', created: 'Oct 5, 2024', folder: 'contracts-additional' }),
      baseDoc({ id: 'c8', name: 'Lease Agreement - Regional office', documentType: 'Lease Agreement', participants: 'Facilities', status: 'Sent', amount: '$420,000.00', created: 'Jan 8, 2025', folder: 'contracts-additional' }),
      baseDoc({ id: 'c9', name: 'Loan Agreement - Equipment financing', documentType: 'Loan Agreement', participants: 'Finance', status: 'Draft', amount: '$1,200,000.00', created: 'Dec 22, 2024', folder: 'contracts-additional' }),
