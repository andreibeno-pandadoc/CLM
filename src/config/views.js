...
//
// Icons reuse view-1 assets: sales→proposals, hr→service-agreements, legal→contracts, finance→quotes,
// marketing→collaterals, procurement→invoices (see ViewIcons.jsx for React fallbacks).
