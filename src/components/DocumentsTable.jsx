...
import { getViewSampleData } from '../data/viewSampleData';
...
const DocumentsTable = ({
  ...
  const [completionDateFilter, setCompletionDateFilter] = useState(null);
  ...
  // View-specific sample data when viewing a document-type view; otherwise default (main Documents page)
  const viewData = viewId ? getViewSampleData(viewId) : null;
  const defaultFolders = [
    { id: 'proposal-templates', name: 'Proposal templates', itemCount: 3, avatar: defaultUserAvatar, created: 'Jan 10, 2025', documents: [] },
    { id: 'ndas', name: "NDA's", itemCount: 3, avatar: defaultUserAvatar, created: 'Jan 10, 2025', documents: [] },
  ];
  const defaultDocuments = [
    { id: 1, name: 'Proposal for Kraftwerk Events', participants: 'Will Holland, Mariel Stacey', status: 'Draft', amount: '$4,250.00', created: 'May 21, 2024', avatar: img('4.png'), folder: 'proposal-templates', autoRenew: true },
    { id: 2, name: 'Equipment Purchase Proposal for Tresor Media', participants: 'Emily Gold, Nathan Howard', status: 'Sent', amount: '$9,780.00', created: 'Nov 2, 2024', avatar: img('2.png'), folder: 'proposal-templates', autoRenew: true },
    { id: 4, name: 'Equipment Purchase Proposal for Captured Moments', participants: 'Andreya Triana, Will Holland', status: 'Awaiting approval', amount: '$6,560.00', created: 'Jan 10, 2025', avatar: img('3.png'), folder: 'proposal-templates', autoRenew: false },
    { id: 3, name: 'Non-Disclosure Agreement for Brilliant Moments Inc.', participants: 'Mariel Stacey', status: 'Completed', amount: '', created: 'Jan 10, 2025', avatar: img('1.png'), folder: 'ndas', autoRenew: false },
    { id: 5, name: 'Non-Disclosure Agreement for Brilliant Moments Inc.', participants: 'Andreya Triana, Will Holland', status: 'Rejected', amount: '', created: 'Jan 10, 2025', avatar: img('4.png'), folder: 'ndas', autoRenew: false },
    { id: 6, name: 'Equipment Purchase Proposal for Tresor Media', participants: 'Emily Gold, Nathan Howard', status: 'Sent', amount: '$9,780.00', created: 'Nov 2, 2024', avatar: img('2.png'), folder: 'ndas', autoRenew: true },
    { id: 7, name: 'Proposal for Kraftwerk Events', participants: 'Will Holland, Mariel Stacey', status: 'Draft', amount: '$4,250.00', created: 'May 21, 2024', avatar: img('4.png'), autoRenew: true },
    { id: 8, name: 'Equipment Purchase Proposal for Tresor Media', participants: 'Emily Gold, Nathan Howard', status: 'Sent', amount: '$9,780.00', created: 'Nov 2, 2024', avatar: img('2.png'), autoRenew: true },
    { id: 9, name: 'Non-Disclosure Agreement for Brilliant Moments Inc.', participants: 'Mariel Stacey', status: 'Completed', amount: '', created: 'Jan 10, 2025', avatar: img('1.png'), autoRenew: false },
    { id: 10, name: 'Equipment Purchase Proposal for Captured Moments', participants: 'Andreya Triana, Will Holland', status: 'Awaiting approval', amount: '$6,560.00', created: 'Jan 10, 2025', avatar: img('3.png'), autoRenew: false },
    { id: 11, name: 'Non-Disclosure Agreement for Brilliant Moments Inc.', participants: 'Andreya Triana, Will Holland', status: 'Rejected', amount: '', created: 'Jan 10, 2025', avatar: img('4.png'), autoRenew: false },
  ];
  const folders = viewData ? viewData.folders : defaultFolders;
  const allDocuments = viewData ? viewData.documents : defaultDocuments;
  ...
  const filterBySearch = (doc) => {
    ...
    // Status filter (align with documents-next Status popover + legacy mock labels)
    if (statusFilter.length > 0) {
      const docStatus = doc.status?.toLowerCase().replace(/\s+/g, '-') || '';
      const matches = statusFilter.some((sel) => {
        if (sel === 'declined') return docStatus === 'declined' || docStatus === 'rejected';
        if (sel === 'for-approval') return docStatus === 'for-approval' || docStatus === 'awaiting-approval';
        return docStatus === sel;
      });
  ...
  // Unique documents for autoRenew/duration filter: use view docs when in a view, else default list
  const defaultAutoRenewDocs = [
    { id: 'ar-1', name: 'Proposal for Kraftwerk Events', participants: 'Will Holland, Mariel Stacey', status: 'Draft', amount: '$4,250.00', created: 'May 21, 2024', avatar: img('4.png'), autoRenew: true, duration: 12 },
    { id: 'ar-2', name: 'Equipment Purchase Proposal for Tresor Media', participants: 'Emily Gold, Nathan Howard', status: 'Sent', amount: '$9,780.00', created: 'Nov 2, 2024', avatar: img('2.png'), autoRenew: true, duration: 12 },
    { id: 'ar-3', name: 'Non-Disclosure Agreement for Brilliant Moments Inc.', participants: 'Mariel Stacey', status: 'Completed', amount: '', created: 'Jan 10, 2025', avatar: img('1.png'), autoRenew: false, duration: 24 },
    { id: 'ar-4', name: 'Equipment Purchase Proposal for Captured Moments', participants: 'Andreya Triana, Will Holland', status: 'Awaiting approval', amount: '$6,560.00', created: 'Jan 10, 2025', avatar: img('3.png'), autoRenew: false, duration: 6 },
    { id: 'ar-5', name: 'Non-Disclosure Agreement for Brilliant Moments Inc.', participants: 'Andreya Triana, Will Holland', status: 'Rejected', amount: '', created: 'Jan 10, 2025', avatar: img('4.png'), autoRenew: false, duration: 36 },
  ];
  const uniqueDocumentsForAutoRenew = viewData
    ? allDocuments.slice(0, 5).map((d, i) => ({ ...d, duration: [12, 24, 6, 36, 12][i] ?? 12 }))
    : defaultAutoRenewDocs;
    ...
    return (
      ...
      >
        ...
        <div className="w-40 flex items-center gap-2 ml-6">
          <Avatar src={doc.avatar || defaultUserAvatar} alt="User avatar" size="sm" />
          <span className="text-13 font-graphik-regular text-secondary-dark">
  ...
  const renderImportedFolder = (folder) => {
    ...
    return (
      ...
      >
        ...
        {/* Created Column */}
        <div className="w-40 flex items-center gap-2 ml-6">
          <Avatar src={defaultUserAvatar} alt="User avatar" size="sm" />
          <span className="text-13 font-graphik-regular text-secondary-dark">
  ...
  return (
    <div className="bg-white">
      {/* Filter Bar - hidden when hideFilterBar or (in Views) when filtersVisible is false; when visibleFilterIds provided, only those filters show */}
      {!hideFilterBar && filtersVisible && (
        <FilterBar 
          ...
          setCompletionDateFilter={setCompletionDateFilter}
          dueDateFilter={dueDateFilter}
          setDueDateFilter={setDueDateFilter}
          dateSentFilter={dateSentFilter}
      ...
      {/* Table Header */}
      <div className="flex items-center h-10 border-b border-thesis-border text-13 font-graphik-regular text-secondary-light">
        <div className="flex-1 min-w-0 flex items-center">
          <div className="w-12 flex justify-center">
            <input 
              type="checkbox" 
              ...
              className="w-4 h-4 rounded border-thesis-border text-brand-primary focus:ring-brand-primary" 
            />
          </div>
          {selectedCount > 0 ? (
