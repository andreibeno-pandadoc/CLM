  ...
  return (
    <div className="w-full min-h-full bg-white">
      <div className="p-8 lg:p-10 max-w-none">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-5 py-4 border-b-2 transition-colors ${
                    selectedCategory === category.label
                      ? 'border-brand-primary bg-thesis-chip'
            ...
            <div className="flex items-center gap-4 ml-4">
              ...
              <button type="button" className="flex items-center gap-2 px-3 py-1.5 text-14 font-graphik-semibold text-brand-secondary hover:bg-thesis-ai-tint transition-colors rounded-md">
        ...
        {/* Divider */}
        <div className="border-b border-thesis-border mb-6"></div>
        ...
        <div>
          ...
          <div>
            {recentDocuments.map((doc) => (
              <div
                key={doc.id}
                className="flex items-center h-16 border-b border-thesis-border/25 hover:bg-gray-25 transition-colors cursor-pointer"
              >
                {/* Document Icon + Name */}
