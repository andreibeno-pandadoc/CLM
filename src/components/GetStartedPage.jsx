...
const GetStartedPage = ({ onClose, onOpenGmailImport }) => {
  ...
  const templates = [
    { id: 1, name: 'Software Development Proposal', image: assetUrl('images/Template 1.png') },
    { id: 2, name: 'Agency Agreement Template', image: assetUrl('images/Template 2.png') },
    { id: 3, name: 'Executive Summary Template', image: assetUrl('images/Template 3.png') },
    { id: 4, name: 'Construction Proposal Template', image: assetUrl('images/Template 4.png') },
    { id: 5, name: 'Mobile App Development Proposal', image: assetUrl('images/Template 5.png') },
    { id: 6, name: 'Event Sponsorship Proposal', image: assetUrl('images/Template 6.png') },
    { id: 7, name: 'Product Launch Template', image: assetUrl('images/Template 7.png') },
    { id: 8, name: 'Executive Summary Template', image: assetUrl('images/Template 8.png') },
    { id: 9, name: 'Sold Notice', image: assetUrl('images/Template 9.png') },
    { id: 10, name: 'Marketing Proposal', image: assetUrl('images/Template 10.png') },
  ];
