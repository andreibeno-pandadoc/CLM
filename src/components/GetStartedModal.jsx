              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 1.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 2.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 3.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 4.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 5.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 6.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 7.png')}
                ...
                <div className="group cursor-pointer">
                  <div className="aspect-[3/4] rounded-lg mb-3 hover:shadow-lg transition-shadow overflow-hidden">
                    <img 
                      src={assetUrl('images/Template 8.png')}
                      alt="Executive Summary Template"
                      className="w-full h-full object-cover"
                    />
                  </div>
