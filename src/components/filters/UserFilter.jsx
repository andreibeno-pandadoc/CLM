...
const users = [
  { id: 'ab', name: 'Andrei Beno', email: 'andrei.beno@pandadoc.com', initials: 'AB', color: '#E53935' },
  { id: 'ak', name: 'Anastasia Koshko', email: 'anastasia.koshko@pandadoc.com', avatar: assetUrl('images/1.png') },
  { id: 'as', name: 'Anastasiia Shtunder', email: 'anastasiia.shtunder@pandadoc.com', avatar: assetUrl('images/2.png') },
  ...
  { id: 'ab2', name: 'Andrei Beno (sandbox)', email: 'andrei.beno+2@pandadoc.com', initials: 'A2', color: '#6B7280' },
];
